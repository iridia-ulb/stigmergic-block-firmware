...
CTWController::CTWStatusInterrupt::CTWStatusInterrupt(CTWController* pc_tw_controller,
                                                      uint8_t un_intr_vect_num) : 
   m_pcTWController(pc_tw_controller) {
   Register(this, un_intr_vect_num);
}

CTWController::CTWStatusInterrupt::ServiceRoutine() {
   switch(TW_STATUS) {
      // All Master
